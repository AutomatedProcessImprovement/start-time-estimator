...
def test_estimate_start_times():
    ...
    # The start time of initial events is the initial_time
    assert extended_event_log[0][0]['start:timestamp'] == initial_time
    assert extended_event_log[3][0]['start:timestamp'] == initial_time
