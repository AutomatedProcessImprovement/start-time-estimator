...
def test_resource_availability():
    ...
    assert resource_availability.available_since('Anya', fourth_trace.iloc[0]) == config.non_estimated_time
    ...
    assert resource_availability.available_since(config.missing_resource, artificial_event) == config.non_estimated_time
    # The missing resource is always available since [non_estimated_time]
